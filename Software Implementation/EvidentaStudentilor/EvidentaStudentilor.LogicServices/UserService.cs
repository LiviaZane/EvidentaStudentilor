...
namespace EvidentaStudentilor.LogicServices
{
    public class UserService : IUserService
    {
        ...
        {
            User aa = _wrapperRepository.UserRepository.FindAll().Where(x => x.Id == id).FirstOrDefault();
            Role bb = _wrapperRepository.RoleRepository.FindAll().FirstOrDefault(x => x.Id == aa.RoleId);
            return bb.Name;
        }
